...
print(state)
state_bar = predict(state,0.001,0.1,3)
# NOTE: with speed=3 then delta_t=5
print(state_bar)
print("--- --- ---\n")
...
z = np.array([[1.],[2.]])
print(z)
weights = weight_particles(state_bar,z, 5., 0.002)
print(weights)
print("--- --- ---\n")
...
print(z.shape)
simulation = particle_filter(10,z,0.001,0.01,5.,0.002,0.4,1.)
